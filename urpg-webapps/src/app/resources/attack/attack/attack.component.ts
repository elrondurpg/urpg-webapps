...
import { ContestCombo } from 'src/app/models/contest/ContestCombo';
...
export class AttackComponent extends ResourceComponent<Attack, AttackDelta> implements OnInit {
  ...
  constructor(
    ...
    this.modelDefinition = new ModelDefinition([
      ...
      new SelectAttributeDefinitionBuilder()
        ...
        .withItemsFromObservable(this.service.get(ApiConstants.RSE_CONTEST_MOVE_TYPE_API))
        .build(),
      new SelectAttributeDefinitionBuilder()
        .withTitle("RSE Contest Attribute")
        .withModelSelector("rseContestAttribute.name")
        .withDeltaSelector("rseContestAttribute")
        .withItemsFromObservable(this.service.get(ApiConstants.CONTEST_ATTR_API))
        .build(),
      new SelectAttributeDefinitionBuilder()
        .withTitle("ORAS Contest Move Type")
        .withModelSelector("orasContestMoveType.name")
        .withDeltaSelector("orasContestMoveType")
        .withItemsFromObservable(this.service.get(ApiConstants.ORAS_CONTEST_MOVE_TYPE_API))
        .build(),
      new SelectAttributeDefinitionBuilder()
      ...
      new NestedAttributeDefinitionBuilder(ContestCombo, ContestComboDelta)
        ...
        .withKeyDefinitions([
          new SelectAttributeDefinitionBuilder()
            ...
            .withItemsFromObservable(this.service.get(ApiConstants.ATTACK_API))
            .build(),
          new SelectAttributeDefinitionBuilder()
            .withTitle("Generation")
            .withModelSelector("generation.name")
            .withItemsFromObservable(this.service.get(ApiConstants.CONTEST_TYPE_API))
