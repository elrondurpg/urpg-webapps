...
@Component({
  selector: 'configuration-park-location',
  templateUrl: '../../lib/configuration/configuration.component.html'
})
export class ParkLocationComponent extends ConfigurationComponent<UrpgObjectModel, UrpgObjectModel> implements OnInit {
